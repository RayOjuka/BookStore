    ...
    public class BookRepository
    {
        ...
        private List<BookModel> DataSource()
        {
            return new List<BookModel>()
            {
                ...
                new BookModel() { Id = 6, Title = "Azure DevOps", Author = "Monika", Description = "This is the description for Azure DevOps book", Category = "DevOps", Language = "English", TotalPages = 800 },
            };
        }
    }
}
